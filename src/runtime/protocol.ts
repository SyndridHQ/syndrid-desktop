...
export interface ThreadListParams {
  cursor?: string | null; limit?: number | null; sortKey?: string | null; sortDirection?: string | null;
  modelProviders?: string[] | null; sourceKinds?: string[] | null; archived?: boolean | null;
  cwd?: string | string[] | null; useStateDbOnly?: boolean; searchTerm?: string | null;
}
export interface ThreadSummary {
  id: string; sessionId: string; forkedFromId: string | null; parentThreadId: string | null; preview: string;
  ephemeral: boolean; modelProvider: string; createdAt: number; updatedAt: number; recencyAt: number | null;
  status: unknown; path: string | null; cwd: string; cliVersion: string; source: unknown; threadSource: unknown | null;
  agentNickname: string | null; agentRole: string | null; gitInfo: unknown | null; name: string | null; turns: unknown[];
}
...
export interface ThreadStartParams {
  ...
  approvalPolicy?: unknown; approvalsReviewer?: unknown; sandbox?: unknown; config?: Record<string, unknown> | null;
  serviceName?: string | null; baseInstructions?: string | null; developerInstructions?: string | null;
  personality?: unknown; ephemeral?: boolean | null; sessionStartSource?: unknown; threadSource?: unknown;
}
export interface ThreadStartResponse {
  thread: ThreadSummary; model: string; modelProvider: string; serviceTier: string | null; cwd: string;
  instructionSources: string[]; approvalPolicy: unknown; approvalsReviewer: unknown; sandbox: unknown; reasoningEffort: unknown | null;
}
...
export interface TurnSummary {
  id: string; items: unknown[]; itemsView: unknown; status: unknown; error: unknown | null;
  startedAt: number | null; completedAt: number | null; durationMs: number | null;
}
export interface TurnStartParams {
  threadId: string; clientUserMessageId?: string | null; input: UserInput[]; cwd?: string | null;
  approvalPolicy?: unknown; approvalsReviewer?: unknown; sandboxPolicy?: unknown; model?: string | null;
  serviceTier?: string | null; effort?: unknown; summary?: unknown; personality?: unknown; outputSchema?: unknown;
}
...
export interface ModelSummary {
  id: string; model: string; upgrade: string | null; upgradeInfo: unknown | null; availabilityNux: unknown | null;
  displayName: string; description: string; hidden: boolean; supportedReasoningEfforts: unknown[]; defaultReasoningEffort: unknown;
  inputModalities: unknown[]; supportsPersonality: boolean; additionalSpeedTiers: string[]; serviceTiers: unknown[];
